...
for (const line of lines) {
  ...
  const fam = byId.get(p.family.id);
...
console.log(`priced SKUs=${priced} sizes added=${added} sizes with price=${sizesWithPrice}/${sizesTotal} unparsed=${unparsed.length}`);
